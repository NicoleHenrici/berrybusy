...
interface FormElementsProps {
  key: number;
  section: Section;
  extendListHandler?: (e: React.MouseEvent<HTMLButtonElement>, section: Section) => void;
  onDeleteListElement?: (e: React.MouseEvent<HTMLButtonElement>, section: Section, fieldIndex: number) => void;
}

export default function FormElements({key, section, extendListHandler, onDeleteListElement}: FormElementsProps) {
